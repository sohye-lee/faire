...
const Profile: NextPage = () => {
  return (
    <div className="max-w-md mx-auto py-16 flex flex-col space-y-4">
      <div className="flex px-4 items-center space-x-3 py-3 border-t border-b cursor-pointer">
      ...
      <div className="px-4 mt-3 border-t py-3">
        <div className="flex space-x-2 items-center">
          <div className="w-8 h-8 bg-purple-200 rounded-full" />
          <div className="">
            <h4 className="font-serif text-sm text-gray-700 px-1">Chloe K.</h4>
